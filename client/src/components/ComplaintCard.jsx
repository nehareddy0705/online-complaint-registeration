...
const ComplaintCard = ({ complaint }) => {
  ...
  return (
    <div className="surface-panel rounded-[1.25rem] hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200 flex flex-col h-full overflow-hidden animate-fade-in group">
      {/* Top Banner section */}
      <div className="p-5 flex-1">
        <div className="flex justify-between items-start mb-3">
          <span className="text-[10px] tracking-wider uppercase font-bold text-slate-500 bg-white/80 px-2 py-0.5 rounded-full border border-[#d8cbb8]">
            {category}
          </span>
        ...
        <h3 className="text-base font-bold text-gov-dark mb-2 truncate group-hover:text-gov-primary transition-colors">
          {title}
        </h3>
      ...
      {/* Footer link section */}
      <div className="bg-white/60 border-t border-[#d8cbb8] px-5 py-3 flex justify-between items-center text-xs font-medium text-slate-500">
