...
const Register = () => {
  ...
  return (
    <div className="flex-1 bg-gov-light flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full surface-panel rounded-[1.75rem] overflow-hidden animate-fade-in">
        
        {/* Header Branding */}
        <div className="bg-[linear-gradient(135deg,#24384d_0%,#3f5f78_100%)] text-white text-center py-8 px-6 border-b border-white/10">
          <div className="bg-gov-card p-3 rounded-2xl text-gov-dark w-fit mx-auto shadow-md mb-3">
            <Landmark className="w-8 h-8" />
          </div>
          <h2 className="text-xl font-extrabold tracking-tight m-0">
            Create a Sahaay Account
          </h2>
          <p className="text-xs text-white/75 font-medium tracking-wide mt-1 m-0">
